 ...
 */
function createChainConfig(rpcUrl: string, chainId?: number) {
 ...
 */
export async function updateContractAnchor(
  newAnchor: string,
  config?: ContractUpdateConfig
 ...
 */
export function createAnchorUpdateCallback(config?: ContractUpdateConfig) {
  return async (newAnchor: string): Promise<void> => {
 ...
 */
export function logContractUpdateResult(
  newAnchor: string,
